// ==UserScript==
// @name          Roll20 Dark Edit
// @description	  A dark theme for Roll20.net.
// @author        RedReign feat. Michiocre
// @include       https://app.roll20.net/editor/
// @include       https://app.roll20.net/campaigns/chatarchive*
// @run-at        document-start
// @version       2021.04.06.1
...
#zoomslider a.ui-slider-handle.ui-state-default.ui-corner-all {
    ...
    border: 2px solid hsl(0, 0%, 10%) !important;
}
...
.ui-tabs .ui-tabs-nav li a:hover {
	outline: none;
	border-bottom: 2px solid hsl(30,100%,50%) !important;
...
#textchat .message.you {
	color:hsl(0,0%,80%)!important;
	background-color:hsl(43,63%,10%) !important;
}
